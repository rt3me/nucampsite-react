...
import { Card, CardImg, CardText, CardBody, CardImgOverlay, Breadcrumb, BreadcrumbItem, Button, Modal, ModalHeader, ModalBody, Label } from "reactstrap";
        ...
        <Card>
          ...
          <CardImgOverlay>
            <Button outline color="primary" onClick={() => (favorite ? console.log("Already favorite") : postFavorite(campsite._id))}>
              {favorite ? <i className="fa fa-heart" /> : <i className="fa fa-heart-o" />}
            </Button>
          </CardImgOverlay>
          <CardBody>
    ...
    return (
      <div className="container">
        ...
        <div className="row">
          ...
          <RenderComments comments={props.comments} postComment={props.postComment} campsiteId={props.campsite._id} />
        </div>
      </div>
    );
  }
